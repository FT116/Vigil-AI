...
##  System Workflow
1. **User Prompt**: The user submits a prompt for image generation.
...
3. **Vigil AI Safety Classifier**: The (translated if needed) prompt is analyzed by the best-performing Transformer model.
...
5. **Refusal Response**: A clear explanation of why the prompt was blocked is provided to the user.
...
1. **DistilBERT**: Fast and lightweight.
2. **RoBERTa**: Robust and accurate **(final selected model)**
3. **MiniLM**: Optimized for inference speed.
